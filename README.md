...
Add Node: Click the action button on the header panel to instantiate structural blocks.

Move Components: Drag node bounding frames directly with your mouse cursor.

Edge Mode Links: Toggle the link tool to "ON", click a source component box, and select a target component box to anchor a persistent line link.
